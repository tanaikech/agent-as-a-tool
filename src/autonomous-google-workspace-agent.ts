 ...
 *
 * ref: https://medium.com/google-cloud/empowering-autonomous-ai-agents-through-dynamic-tool-creation-550683f255a4
 * ref: https://github.com/tanaikech/autonomous-google-workspace-agent/blob/master/src/agent.ts
 */
